...
1. Main use case: For AI chat bots, it makes it easy to make the AI read a lot of the codebase and have an insigh of what is this directory/project.
2. Secondary use case: to have simple and stupid backup of a directory instead of git, combined with another script in this `Scripts` repo called `mdcreate`.
